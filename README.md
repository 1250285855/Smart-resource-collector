...
## Install
This project is made by three part, server part, client part and raspberry-pie.
### Server
...
Prepare [Python](https://www.python.org) environment in your raspberry-pie, and move [Raspberry-pie](Raspberry-pie) to your raspberry-pie. and make sure the [ServoTest.py](ServoTest.py) can run successfully.
## Usage
...
### Raspberry-pie
Active the listen and control program.
```sh
